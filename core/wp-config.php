...
define('RSSSL_KEY', 'BuHfrbo59JyJVOT2tjQjFT7Rn5XzFJBjIdeemv9yBqp6UBMM1XtBA9twjU47V3Se');
...
define( 'DB_NAME', 'lilianpro_wp2' );

/** Имя пользователя базы данных */
define( 'DB_USER', 'lilianpro_wp2' );

/** Пароль к базе данных */
define( 'DB_PASSWORD', 'Mu12xW^7D' );
